...
document.body.insertAdjacentHTML("afterbegin", `
    <div class="container-fullwidth">
        <nav class="navbar navbar-expand-lg px-4 um-yellow-bg">
            <img src="` + imgLink + `" width="150" class="py-1"></img>
                    <h1 class="mx-3 um-brown">|</h1>
                    <a class="navbar-brand" href="` + homeLink + `"><h3 class="um-brown">Aurora</h3></a>
        </nav>
